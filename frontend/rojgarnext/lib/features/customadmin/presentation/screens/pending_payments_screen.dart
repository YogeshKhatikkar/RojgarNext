// lib/features/customadmin/presentation/screens/pending_payments_screen.dart
...
class _PendingPaymentsScreenState extends State<PendingPaymentsScreen> {
  ...
  // ✅ FIXED: Use customadmin endpoint
  Future<void> _fetchPending() async {
    try {
      final res = await DioClient.dio.get("/customadmin/pending-payments");
      if (!mounted) return;
      setState(() {
  ...
  // ✅ FIXED: Use customadmin endpoint for verify
  Future<void> _verify(String paymentId, bool approve, {String? notes}) async {
    try {
      final res = await DioClient.dio.post(
        "/customadmin/verify-payment/$paymentId", // Changed from /admin/ to /customadmin/
        queryParameters: {
